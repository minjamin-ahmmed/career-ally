...
const Slider = () => {
    return (
        <Swiper
            ...
            navigation={true}
            className="w-full lg:h-screen h-[50vh]  md:h-[90vh]"
            breakpoints={{
                1024: {
                    slidesPerView: 1,
                    spaceBetween: 20,
        ...
        >
            ...
            <SwiperSlide>
                <img src={img4} alt="Slider 4" className="w-full h-full lg:object-cover md:object-cover" />
            </SwiperSlide>
            <SwiperSlide>
                <img src={img5} alt="Slider 5" className="w-full h-full lg:object-cover md:object-cover" />
            </SwiperSlide>
        </Swiper>
    );
};
